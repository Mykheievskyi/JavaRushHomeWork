...
public class Solution {
    ...
    {
        Class<?> [] intarface = new Class[classes.length + 1];
        System.arraycopy(classes, 0, intarface, 0, classes.length);
        intarface[intarface.length - 1] = aClass;


        return (T) Proxy.newProxyInstance(aClass.getClassLoader(), intarface, new ItemInvocationHandler());
    }
