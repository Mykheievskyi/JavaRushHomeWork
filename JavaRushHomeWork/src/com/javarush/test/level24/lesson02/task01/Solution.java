...
public class Solution {
    ...
    public static class Test1 implements Cloneable //отметил интерфейсом-маркером clonable
    {
    ...
    public static class Test3 implements Cloneable //отметил интерфейсом-маркером clonable
    {
    ...
    public static class Test4 extends Test3
    {
        ...
        protected Test4 clone() throws CloneNotSupportedException{ //дописал метод clone()
            return new Test4();
        }
    }
}
