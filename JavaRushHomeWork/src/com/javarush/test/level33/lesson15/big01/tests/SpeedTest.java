...
public class SpeedTest
{
    ...
    public void testHashMapStorage() {
        ...
        long times1 = getTimeForGettingIds(shortener1, origStrings, ids1);
        long times2 = getTimeForGettingIds(shortener2, origStrings, ids2);

        Assert.assertTrue(times1 > times2);
