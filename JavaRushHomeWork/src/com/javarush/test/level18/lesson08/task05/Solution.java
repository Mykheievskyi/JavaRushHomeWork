...
public class Solution {
    ...
    {
        private ATableInterface content;

        public TableInterfaceWrapper(ATableInterface content)
        {
        ...
        public void setModel(List rows) {
            ...
            content.setModel(rows);
        }

        @Override
        public String getHeaderText()
        {
            return content.getHeaderText().toUpperCase();
        }

        @Override
        public void setHeaderText(String newHeaderText)
        {
            content.setHeaderText(newHeaderText);
        }
    }
