...
public class Solution {
    ...
    private static void start(List<Character> characters) throws InterruptedException {
        final Phaser phaser = new Phaser(1 + characters.size()); // 1  - что бы зарегестрировать себя
        ...
        for (final Character character : characters)
        {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    phaser.arriveAndAwaitAdvance(); // ждет все треды
        ...
        phaser.arriveAndDeregister(); // запускает все треды
